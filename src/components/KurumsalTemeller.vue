    ...
    <div class="flex flex-col items-center my-12">
        <div class="w-full flex flex-col items-center">
            ...
            <div class="w-full max-w-[1200px] px-4 lg:px-0">
                <a href="/denizefr24/DenizBank_EFR_2024.pdf#page=69" target="_blank"
                ...
                <p class="text-gray-800 text-sm sm:text-xl font-normal mb-12 max-w-3xl"
                   data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
                    Risklerin doğru yönetilmesi, güncel güvenlik önlemlerinin alınması ve çalışanların siber güvenlik konusunda bilinçlendirilmesi, veri güvenliğini sağlamanın en etkili yollarıdır.
                </p>
                ...
                <div class="w-full flex flex-col gap-5 mb-12">
                    <div class="flex gap-6 items-start pt-3 hover:bg-green-50 p-4 rounded-lg transition-all feature-item"
                        ...
                        <p class="text-gray-800 text-sm sm:text-xl font-normal fade-in-text">
                            	Finansal uygulamaların güvenliğinin sağlanması amacıyla 300 farklı geliştirme, sızma testine tabi tutularak bulgular canlı ortama alınması öncesinde giderilmiştir.
                        </p>
                    </div>
                    ...
                    <div class="flex gap-6 items-start pt-3 hover:bg-green-50 p-4 rounded-lg transition-all feature-item"
                        ...
                        <p class="text-gray-800 text-sm sm:text-xl font-normal fade-in-text">
                            	Yüksek riskli kullanıcılar üzerinde çalışmalar yapılarak kimlik kaynaklı risklerin %30 azaltılması sağlanmıştır.
                        </p>
                    </div>
                    ...
                    <div class="flex gap-6 items-start pt-3 hover:bg-green-50 p-4 rounded-lg transition-all feature-item"
                        ...
                        <p class="text-gray-800 text-sm sm:text-xl font-normal fade-in-text">
                            	Yıl içerisindeki 200+ risk değerlendirme ile süreç olgunluk seviyesi bağımsız denetim kurumu tarafından 5 üzerinden 3.72 olarak değerlendirilmiştir.</p>
                    </div>
            </div>
                ...
                <ul class="list-disc list-inside mt-4">
                    <li class="list-item" data-aos="fade-right" data-aos-duration="400" data-aos-delay="50">Teftiş Kurulu Başkanlığı</li>
                    <li class="list-item" data-aos="fade-right" data-aos-duration="400" data-aos-delay="100">İç Kontrol Merkezi Başkanlığı</li>
                    <li class="list-item" data-aos="fade-right" data-aos-duration="400" data-aos-delay="150">Uyum Başkanlığı</li>
                    <li class="list-item" data-aos="fade-right" data-aos-duration="400" data-aos-delay="200">Risk Yönetimi Başkanlığı</li>
                    <li class="list-item" data-aos="fade-right" data-aos-duration="400" data-aos-delay="250">Bilgi Güvenliği ve BT Risk Yönetimi Grubu </li>
                </ul> <br>
                <p>
            ...
            <!-- Header Section -->
            <div class="w-full max-w-[1200px] px-4 lg:px-0">
                <a href="/denizefr24/DenizBank_EFR_2024.pdf#page=83" target="_blank"
                   class="group transition-all duration-300">
                   <h1 class="text-[#072CAD] text-xl sm:text-4xl font-bold mb-8 group-hover:underline header-title"
                      data-aos="fade-down" data-aos-duration="800">
                    Kurumsal Yönetim

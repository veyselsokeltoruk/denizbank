<template>
    <div class="relative overflow-hidden h-[500px] rounded-lg shadow-lg group">
        ...
        <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
            src="/slide-4.png" alt="Geleceğin Yeteneği">
                ...
                <div
                    ...
                    <div class="flex justify-end">
                        ...
                        <h2
                            ...
                            Geleceğin <br> <span class="text-white">Yeteneği</span>
                        </h2>
                    </div>
                    <div
                    ...
                    <p
                        ...
                        Sürdürülebilirlik hedefleri için gereken dönüşümün temel taşlarından biri yeni nesil
                        yeteneklerdir.
                    </p>
                </div>
